              ...
              {menu.map((item, index) => (
                ...
                >
                  {item.url ? (
                    <Link
                      href={item && item?.url}
                      className={`px-1 relative lg:inline-block block lg:rounded-md xl:text-[20px] text-[18px] font-bold menu-link pt-3 pb-1 lg:border-0 border-solid lg:border-b-[#FBEF3C] lg:text-[#262626] text-white transition-all duration-300 ease-in-out hover:text-[#e91b72]
                                            ${
